...
# a=0
# # 0=request, 1=logged in, 2=not logged in

# while a==0: #while because I want a repetition
#   user_input=input('please enter password ')
#   if user_input == password:
#     a=1
#   else:
...
#   print(a)
------------------------------------------------------------------------
# sandwich_orders=["Chicken Sandwich",
#                   "Egg Sandwich",
#                   "Fish Sandwich",
#                   "Fried Egg Sandwich",
...
#   print("Your {} have been made.\n".format(finished_sandwiches))

# print('your complete sandwich is {}\n'.format(finished_sandwiches))

# # print('your total sandwich is \n')

# a=[1,2,4,45,55]
# a.insert(2, 10) #how to use insert 
# print(a)
